...
# CSV path
csv_path = "xgboost_binary_evaluation.csv"
...
for file_name in dataset_files:
    try:
        ...
        xgb_model.fit(X_tabpfn_train, y_tabpfn_train)
        ...
        probs = xgb_model.predict_proba(X_tabpfn_val)
        ...
        probs = xgb_model.predict_proba(X_tabpfn_test)
